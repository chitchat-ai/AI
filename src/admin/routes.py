...
from src.prompts import EXAMPLE_PROMPT_TEMPLATE
...
async def create_config_form(request: Request):
    return templates.TemplateResponse("create_config.html", {"request": request, "example_prompt_template": EXAMPLE_PROMPT_TEMPLATE})
...
async def create_configs(
    ...
    short_memory_length: int = Form(...),
    long_memory_length: int = Form(...),
    ...
    config_data = Config(
        ...
        short_memory_length=short_memory_length,
...
async def edit_config_form(request: Request, config_id: str, db=Depends(get_database)):
    ...
    if config:
        return templates.TemplateResponse("edit_config.html", {"request": request, "config": config, "config_id": config_id, "example_prompt_template": EXAMPLE_PROMPT_TEMPLATE})
